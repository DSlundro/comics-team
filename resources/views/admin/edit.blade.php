...
<div class="container">
    ...
    <form action="{{route('character.store')}}" method="post">
        ...
        <div class="mb-3">
            ...
            <small id="nameHelper" class="text-muted">Edit the character name here</small>
        </div>
        ...
        <div class="mb-3">
            ...
            <small id="cover_imageHelper" class="text-muted">Edit the character cover image image here</small>
        </div>
        ...
        <button type="submit" class="btn btn-success">Update Character info</button>
    </form>
